...
All the environments are registered in the `vla_data_collect_from_rl` extension. They start
...
import vla_data_collect_from_rl.tasks  # noqa: F401


def main():
    """Print all environments registered in `vla_data_collect_from_rl` extension."""
